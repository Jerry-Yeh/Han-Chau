...
const addons$1 = __STORYBOOK_MODULE_PREVIEW_API__.addons;
const once = __STORYBOOK_MODULE_CLIENT_LOGGER__.once;
const logger = __STORYBOOK_MODULE_CLIENT_LOGGER__.logger;
const FORCE_REMOUNT$1 = __STORYBOOK_MODULE_CORE_EVENTS__.FORCE_REMOUNT;
...
const STORY_RENDER_PHASE_CHANGED$1 = __STORYBOOK_MODULE_CORE_EVENTS__.STORY_RENDER_PHASE_CHANGED;
...
channel.on(FORCE_REMOUNT, () => spies.forEach((mock) => {
  var _a2;
  return (_a2 = mock == null ? void 0 : mock.mockClear) == null ? void 0 : _a2.call(mock);
}));
...
//# sourceMappingURL=preview.561a1fb7.js.map
