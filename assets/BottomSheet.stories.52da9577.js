import{r as t}from"./index.2e2f892a.js";import{a as l,j as r}from"./jsx-runtime.db436af5.js";import{H as u}from"./Button.580b16c7.js";import{H as i,X as G}from"./x-mark.dc31b258.js";import"./_commonjsHelpers.712cc82f.js";import"./index.0579b088.js";import"./index.f32aad8f.js";import"./nonIterableRest.3d34b57d.js";import"./slicedToArray.46bf6900.js";import"./extends.f25a7a22.js";import"./toArray.f27e8e4d.js";import"./assertThisInitialized.220b4aa7.js";import"./index.c5b7136a.js";import"./statistic.472a1099.js";import"./index.32e22ee9.js";import"./ResizeObserver.es.bd9ff68d.js";const M=e=>{var N;const a=t.exports.useRef(null),[o,n]=t.exports.useState(0),[A,g]=t.exports.useState(!1),[w,O]=t.exports.useState(0),[h,E]=t.exports.useState(!1),[Y,p]=t.exports.useState("top-full"),[K,C]=t.exports.useState(""),X=s=>{g(!0),O(s.pageY)},y=t.exports.useCallback(s=>{g(!1),s.pageY<w?E(!0):h&&E(!1)},[w,h,e.onClose]);t.exports.useEffect(()=>{var s;a.current&&n((s=a.current)==null?void 0:s.clientHeight)},[(N=a.current)==null?void 0:N.children]),t.exports.useEffect(()=>(e.handle&&A&&document.addEventListener("mouseup",y),()=>{document.removeEventListener("mouseup",y)}),[e.handle,A,y]),t.exports.useEffect(()=>{let s;return e.show?h?(p("top-6"),C("bottom-0")):e.keyboard||e.handle?(p("top-50"),C("bottom-0")):p(""):(p("top-full"),s=setTimeout(()=>{C("")},800)),()=>{s&&clearTimeout(s)}},[e.show,e.handle,e.keyboard,h,o]);const[W,F]=t.exports.useState(""),[z,D]=t.exports.useState("invisible");return t.exports.useEffect(()=>{let s;return e.show?s=setTimeout(()=>{F("drop-shadow-reversed"),D("visible")},0):s=setTimeout(()=>{F(""),D("invisible")},800),()=>{clearTimeout(s)}},[e.show]),l("div",{className:`${e.className} w-full h-full`,children:[e.backdrop&&r("div",{className:`
            ${z}
...
}`,...(S=(B=m.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var v,H,P;f.parameters={...f.parameters,docs:{...(v=f.parameters)==null?void 0:v.docs,source:{originalSource:`(args: Props) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(P=(H=f.parameters)==null?void 0:H.docs)==null?void 0:P.source}}};var R,j,U;b.parameters={...b.parameters,docs:{...(R=b.parameters)==null?void 0:R.docs,source:{originalSource:`(args: Props) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(T=(q=_.parameters)==null?void 0:q.docs)==null?void 0:T.source}}};var $,I,L;x.parameters={...x.parameters,docs:{...($=x.parameters)==null?void 0:$.docs,source:{originalSource:`(args: Props) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(L=(I=x.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};const fe=["Basic","Header","HeaderPrefixAndSuffix","Keyboard","Handle"];export{m as Basic,x as Handle,f as Header,b as HeaderPrefixAndSuffix,_ as Keyboard,fe as __namedExportsOrder,me as default};
//# sourceMappingURL=BottomSheet.stories.52da9577.js.map
