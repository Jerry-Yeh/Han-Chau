import { a as __toESM, _ as __commonJS } from "./DocsRenderer-QMFTTPNP.71639437.js";
...
var OverlayScrollbarsComponent = ({ options = {}, extensions, className, children, ...rest }) => {
  let osTargetRef = react.exports.useRef(), osInstance = react.exports.useRef();
  return react.exports.useEffect(() => (osInstance.current = (0, import_overlayscrollbars.default)(osTargetRef.current, options, extensions), mergeHostClassNames(osInstance.current, className), () => {
  ...
  }, [options]), react.exports.useEffect(() => {
...
//# sourceMappingURL=OverlayScrollbars-VAV6LJAB.8fea57b7.js.map
