...
var withOutline = (StoryFn, context) => {
  let { globals: globals2 } = context, isActive = globals2[PARAM_KEY] === true, isInDocs = context.viewMode === "docs", outlineStyles = useMemo(() => {
...
var decorators = [withOutline], globals = { [PARAM_KEY]: false };
export {
  decorators,
  globals
};
