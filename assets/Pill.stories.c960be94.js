import{r as d}from"./index.2e2f892a.js";import{j as t}from"./jsx-runtime.db436af5.js";import"./_commonjsHelpers.712cc82f.js";const n=e=>t("div",{className:"flex gap-x-2 overflow-auto scrollbar-hide",children:e.list.map((l,r)=>t("button",{className:"py-1 cursor-pointer",onClick:()=>e.onChange(l.value),children:t("div",{className:`
                ...
                ${e.activeKey===l.value?"bg-highlight-light text-highlight":"bg-secondary text-secondary"}`,children:l.label})},r))}),o=n;try{n.displayName="Pill",n.__docgenInfo={description:"",displayName:"Pill",props:{activeKey:{defaultValue:null,description:"",name:"activeKey",required:!0,type:{name:"Nullable<string | number>"}},list:{defaultValue:null,description:"",name:"list",required:!0,type:{name:"PillItem[]"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!0,type:{name:"(value: string | number) => void"}}}}}catch{}const v={title:"Components/Pill",component:o,argTypes:{list:{control:!1,description:"Data array for pill.",table:{type:{summary:"array"},defaultValue:{summary:"[]"}}},activeKey:{control:!1,description:"Current active key.",table:{type:{summary:"Nullable<string | number>"},defaultValue:{summary:"null"}}},onChange:{control:!1,description:"Callback executed when pill is clicked.",table:{type:{summary:"Function"}}}}},m=[{label:"\u6A19\u7C64",value:1},{label:"\u6A19\u7C64",value:2},{label:"\u6A19\u7C64",value:3},{label:"\u6A19\u7C64",value:4},{label:"\u6A19\u7C64",value:5},{label:"\u6A19\u7C64",value:6}],a=()=>{const[e,l]=d.exports.useState(null);return t(o,{activeKey:e,list:m,onChange:c=>l(c)})};var u,s,i;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`() => {
...
}`,...(i=(s=a.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const h=["Basic"];export{a as Basic,h as __namedExportsOrder,v as default};
//# sourceMappingURL=Pill.stories.c960be94.js.map
