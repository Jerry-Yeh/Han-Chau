...
}`,...(T=(U=b.parameters)==null?void 0:U.docs)==null?void 0:T.source}}};var V,$,q;C.parameters={...C.parameters,docs:{...(V=C.parameters)==null?void 0:V.docs,source:{originalSource:`(args: BottomSheetProps) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(q=($=C.parameters)==null?void 0:$.docs)==null?void 0:q.source}}};var L,O,I;y.parameters={...y.parameters,docs:{...(L=y.parameters)==null?void 0:L.docs,source:{originalSource:`(args: BottomSheetProps) => {
  const [{
    show,
    prefix
  }, updateArgs] = useArgs();
...
}`,...(I=(O=y.parameters)==null?void 0:O.docs)==null?void 0:I.source}}};var Y,M,K;g.parameters={...g.parameters,docs:{...(Y=g.parameters)==null?void 0:Y.docs,source:{originalSource:`(args: BottomSheetProps) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(K=(M=g.parameters)==null?void 0:M.docs)==null?void 0:K.source}}};var z,W,X;A.parameters={...A.parameters,docs:{...(z=A.parameters)==null?void 0:z.docs,source:{originalSource:`(args: BottomSheetProps) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(X=(W=A.parameters)==null?void 0:W.docs)==null?void 0:X.source}}};var G,J,Q;w.parameters={...w.parameters,docs:{...(G=w.parameters)==null?void 0:G.docs,source:{originalSource:`(args: BottomSheetProps) => {
  const [{
    show
  }, updateArgs] = useArgs();
  const handleClose = () => {
...
}`,...(Q=(J=w.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};const Pe=["Basic","Header","HeaderPrefixAndSuffix","Keyboard","Handle","Footer"];export{b as Basic,w as Footer,A as Handle,C as Header,y as HeaderPrefixAndSuffix,g as Keyboard,Pe as __namedExportsOrder,Se as default};
//# sourceMappingURL=BottomSheet.stories.d93ce850.js.map
