import { _ as __vitePreload } from "./iframe.e41adc6a.js";
...
import { u as utils, _ as _getPrototype, e as enhanceArgTypes, S as SNIPPET_RENDERED, a as extractComponentDescription, c as createSummaryValue, g as getDocgenSection, b as SourceType, i as isTooLongForDefaultValueSummary, h as hasDocgen, d as extractComponentProps, T as TypeSystem, f as isTooLongForTypeSummary } from "./index.1fb95844.js";
...
var { FRAMEWORK_OPTIONS } = scope, nodes = /* @__PURE__ */ new Map(), render = (args, context) => {
  ...
  if (!isUsingNewReactRootApi)
    return null;
  let root = nodes.get(el);
  return root || (root = (await __vitePreload(() => import("./client.a91d9f31.js").then((n2) => n2.c), true ? ["./client.a91d9f31.js","./index.36b4d5ff.js","./_commonjsHelpers.712cc82f.js","./index.2e2f892a.js"] : void 0, import.meta.url)).default.createRoot(el), nodes.set(el, root)), root;
...
//# sourceMappingURL=config.dee2e2f9.js.map
