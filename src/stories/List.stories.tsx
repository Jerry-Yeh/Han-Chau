...
const dummyData = [
  { img: <img src={DefaultImage} alt='img' />, title: '標題', content: '描述' },
  { img: <img src={DefaultImage} alt='img' />, title: '標題', content: '描述', type: 'add' },
  { img: <img src={DefaultImage} alt='img' />, title: '標題', content: '描述', type: 'next' },
